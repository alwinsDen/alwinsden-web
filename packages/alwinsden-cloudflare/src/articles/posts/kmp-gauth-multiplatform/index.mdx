export const meta = {
  ...
  cover: '/images/articles/kmp-gauth-multiplatform/Undestand-kotlin-compose.png',
};

> **Note**: If new, checkout KMP architecture @ [KMP - Build Cross-platform](https://kotlinlang.org/multiplatform/)
...
![KMP architecture](/images/articles/kmp-gauth-multiplatform/kmp_client.png)
...
> **Warning**: For this app, the KMP implementation for Android is straight forward compared to iOS, in iOS we use cinterop library to communicate with native iOS Objective C code. Code [**here**](https://github.com/alwinsDen/synapse-ai/tree/master/shared/src/iosMain/kotlin/authManager/ClickTriggerAuth.kt).

### Setting up, expect / actual functions

![Compose Structure](/images/articles/kmp-gauth-multiplatform/compose-structure.png)
...
> **Note**: Since this is not an introduction to expect / actual functions, if you are new to this, it is better to refer [compose documentation](https://kotlinlang.org/docs/multiplatform/multiplatform-expect-actual.html) on this.
...
> **Tip**: This is my first article on KMP, which I too am new to. If you have any feedback or suggestions, please feel free to reach out to me.
