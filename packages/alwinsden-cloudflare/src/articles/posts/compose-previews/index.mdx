export const meta = {
  ...
  author: 'Alwin T Varghese',
  cover: '/images/articles/compose-previews/Undestand-kotlin-compose.png',
};

> **Note**: This is the 2nd article in **Understanding KMP** series. Check out the previous one [here](/articles/kmp-gauth-multiplatform)!

Since the last post, a lot has changed on Project Dino, now renamed to [Synapse](https://github.com/alwinsDen/synapse-ai). The intense white theme has shifted to (or more like in the process) adopting a bright, calm <span style={{background: '#F3DB00', color: '#000000'}}> yellow</span> inspired from [_Pluribus(2025)_](<https://en.wikipedia.org/wiki/Pluribus_(TV_series)>). Last article's code references have been updated.
...
![Synapse login preview](/images/articles/compose-previews/login_preview.png)
...
![Synapse compile time preview](/images/articles/compose-previews/compile_time.gif)
...
![Synapse preview time preview](/images/articles/compose-previews/preview_time.gif)
...
This renders:
![lone render](/images/articles/compose-previews/lone_render.png)
...
This renders:
![multi-render](/images/articles/compose-previews/multi_render.png)
...
![Generate multiple previews.](/images/articles/compose-previews/preview_generate.png)

### Nice! But how does @Preview work?

This will need an article on its own. Will add it soon!

> **Tip**: If you have any feedback or suggestions, please feel free to reach out to me.
